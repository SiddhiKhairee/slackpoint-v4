...
class ShowStore:
    ...
    def create_show_store_blocks(self):
        ...
        block_input_product_id_to_buy = {
            ...
            "label": {"type": "plain_text", "text": "Product ID to Buy"},
        }
        block_buy_item_button = {
            ...
            "accessory": {
                "type": "button",
                "text": {"type": "plain_text", "text": "Buy Item", "emoji": True},
    ...
    def buy_item(self, slack_user_id, product_id):
        ...
        user_inventory = (
            ...
            .filter_by(user_id=user.user_id, product_id=product.product_id)
            .first()
        )
        if user_inventory is None:
            user_inventory = Inventory(
                user_id=user.user_id, product_id=product.product_id, quantity=1
            )
